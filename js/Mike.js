$(function() {
    ...
    function listerEven() {
        $("a.medium-button.button-red.add-cart").click(function(e) {
            ...
            console.log("Object recuperer dans les localStorage")
            ...
            console.log("Récuperation de la data enregister dans la balise")
            console.log(item)
            var update = false;
            ...
            console.log("Nouvelle object qui va etre mis dans le localStorage")
            console.log(datalocal)
